...
- Scaffold `apps/core-api` with Java 21, Maven Wrapper, Spring Boot, Spring Security, Spring Data JPA (Hibernate-generated schema), Bean Validation, Springdoc, and PostgreSQL.
