...
import { isNavigationLink } from "../lib/account-navigation";
import type { AccountNavigationItem } from "../types/account";

type AccountNavItemProps = {
    readonly item: AccountNavigationItem;
    readonly isActive: boolean;
    /** Called when an action row is chosen. Ignored by rows that navigate. */
    readonly onSelect?: () => void;
};

export function AccountNavItem({ item, isActive, onSelect }: AccountNavItemProps) {
