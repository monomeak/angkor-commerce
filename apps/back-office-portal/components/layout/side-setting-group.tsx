...
export function SidebarCollapsibleGroup({ item, pathname, userRole }: SidebarCollapsibleGroupProps) {
    ...
    const isGroupActive =
        ...
        (item.items?.some((subItem) => pathname === subItem.href || pathname.startsWith(`${subItem.href}/`)) ?? false);
                ...
                <CollapsibleTrigger
                    render={
                        <SidebarMenuButton
                            ...
                            tooltip={t(item.titleKey) ?? item.titleKey}
                            ...
                            return (
                                <SidebarMenuSubItem key={subItem.href}>
                                    ...
                                    >
                                        ...
                                        <span>{t(subItem.titleKey) ?? subItem.titleKey}</span>
                                    </SidebarMenuSubButton>
                                </SidebarMenuSubItem>
                            );
                        })}
