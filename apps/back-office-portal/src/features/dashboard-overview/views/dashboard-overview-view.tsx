...
import { CategorySalesCard } from "../components/category-sales-card";
...
export function DashboardOverviewView() {
    ...
    const { summary, revenueByMonth, salesByCategory, recentInvoices } = data;
    ...
    return (
        <div className="space-y-6">
            ...
            <section className="grid min-w-0 gap-6 xl:grid-cols-[minmax(0,2fr)_minmax(320px,1fr)]">
                <RevenueOverviewChart data={revenueByMonth} currency={summary.currency} months={REVENUE_MONTHS} />
                <CategorySalesCard data={salesByCategory} currency={summary.currency} />
            </section>
