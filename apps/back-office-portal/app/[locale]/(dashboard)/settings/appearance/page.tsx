...
import { useAppTheme, type Theme } from "@/components/providers/theme-provider";
        ...
        <div className="w-full space-y-6">
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>Choose how the dashboard should look across your workspace.</CardDescription>
                </CardHeader>
                <CardContent>
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>Static defaults for dashboard layout and formatting.</CardDescription>
                </CardHeader>
                <CardContent>
                    <dl className="divide-y">
                        {preferences.map((preference) => (
                            ...
                            >
                                ...
                                <dd className="text-sm text-muted-foreground">{preference.description}</dd>
