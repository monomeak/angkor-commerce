package com.acme.invoice.auth.impl;

import com.acme.invoice.auth.AuthService;
import com.acme.invoice.auth.RefreshToken;
import com.acme.invoice.auth.RefreshTokenRepository;
...
import com.acme.invoice.security.JwtTokenProvider;
...
public class AuthServiceImpl implements AuthService {
    ...
    public AuthServiceImpl(
        ...
        @Value("${acme.jwt.refresh-token-ttl-days}") long refreshTokenTtlDays
    ) {
